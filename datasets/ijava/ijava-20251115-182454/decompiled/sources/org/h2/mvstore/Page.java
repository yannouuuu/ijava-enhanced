...
public abstract class Page<K, V> implements Cloneable {
    ...
    public final Page<K, V> copy() {
        Page<K, V> mo188clone = mo188clone();
        mo188clone.pos = 0L;
        mo188clone.pageNo = -1;
        return mo188clone;
    }
    ...
    public final Page<K, V> mo188clone() {
        try {
    ...
    public static class NonLeaf<K, V> extends Page<K, V> {
        ...
        /* renamed from: clone */
        protected /* bridge */ /* synthetic */ Object mo188clone() throws CloneNotSupportedException {
            return super.mo188clone();
        }
