...
Écrire le programme `NettoyerChaine` qui à partir d’une variable (`chaine`) contenant une chaîne de retourne la même chaîne privée de l’éventuel caractère espace qui se trouverait en début et/ou en fin de la chaîne.
...
Voici quelques chaînes qu'il est intéressant de tester : `" Bonjour "`, `" Hello"`, "bye "`, `" x "`, `" "`, `""`.
