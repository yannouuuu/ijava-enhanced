...
public class AnalyticsLogger {
    ...
    public static void logTest(String str, List<String> list, int i, List<String> list2, int i2, int i3) {
        ...
        writeToLogFile(String.format("%s,%s,test,%s,[%s],%d,[%s],%d,%d%n", LocalDateTime.now().format(TIMESTAMP_FORMAT), currentSession, str, formatTestList(list), Integer.valueOf(i), formatTestList(list2), Integer.valueOf(i2), Integer.valueOf(i3)));
    }
    ...
    public static void logQCM(String str, String str2, Map<String, String> map, int i, int i2) {
        ...
        writeToLogFile(String.format("%s,%s,qcm,%s,\"%s\",%d,%d%n", LocalDateTime.now().format(TIMESTAMP_FORMAT), str, str2, String.join(",", arrayList), Integer.valueOf(i), Integer.valueOf(i2)));
    }
