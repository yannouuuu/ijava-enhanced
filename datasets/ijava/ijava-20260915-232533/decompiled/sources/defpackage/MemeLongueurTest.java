...
public class MemeLongueurTest extends HiddenTest {
    void _test(Program program, String str, String str2, String str3) {
        expectOutput(program, StudentInteractionSequence.OutputCondition.is("Premier mot : "));
        provideInput(program, str);
        expectOutput(program, StudentInteractionSequence.OutputCondition.is("Second mot : "));
    ...
    void m5testMotsDeLongueursDiffrentes(Program program) {
