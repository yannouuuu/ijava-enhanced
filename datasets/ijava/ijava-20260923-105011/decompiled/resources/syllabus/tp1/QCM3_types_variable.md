...
- [ ] age = 30; 
  > age n'est pas déclarée, juste affectée !
- [x] int age = 30; 
  > Déclaration et initialisation correctes : le type, le nom et la valeur.
- [ ] int age; age = 30; 
  > Presque, mais là, il y séparation entre l'étape de déclaration et ensuite l'initialisation.
- [ ] var age = 30; 
...
- [ ] boolean 
  > boolean = booléen, on l'utilise pour représenter des valeurs vrai (true) ou fausse (false).
:::
...
- [x] x == y 
  > Correct, == est l'opérateur d'égalité pour les types primitifs.
- [ ] x = y 
