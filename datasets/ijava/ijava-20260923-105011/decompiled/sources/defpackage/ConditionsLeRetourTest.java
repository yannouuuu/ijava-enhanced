...
public class ConditionsLeRetourTest extends HiddenTest {
    ...
    void test_bob_bobette_bobby(Program program) {
        _test(program, "bob", "bobette", "bobby", "|bobette| n'est pas avant |bob| dans le dictionnaire\n|bobby| n'est pas préfixe de |bob|\n");
    }
}
