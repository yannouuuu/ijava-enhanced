class ConditionsSurEntiers extends Program {
    ...
    void algorithm(){
        println("Saisissez successivement trois entiers");
        int a = readInt();
        int b = readInt();
        int c = readInt();
