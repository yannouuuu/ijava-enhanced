...
class Semaine3Test extends HiddenTest {
    ...
    void test_variable_globale_lineTurtle_existe(Program program) {
        assertFieldIsDefined(Integer.TYPE, "lineTurtle", program);
    }

    void test_variable_globale_columnTurtle_existe(Program program) {
        assertFieldIsDefined(Integer.TYPE, "columnTurtle", program);
    }

    void test_variable_globale_penDown_existe(Program program) {
        assertFieldIsDefined(Boolean.TYPE, "penDown", program);
    }

    void test_variable_globale_colorPen_existe(Program program) {
        assertFieldIsDefined(String.class, "colorPen", program);
    }

    void test_variable_globale_currentImage_existe(Program program) {
        assertFieldIsDefined(String.class, "currentImage", program);
    }
    ...
    void test_nord_sud_est_ouest(Program program) {
        Semaine3 semaine3 = (Semaine3) program;
        assertFieldIsDefined((Class) new int[0].getClass(), "NORTH", (Program) semaine3);
        assertFieldIsDefined((Class) new int[0].getClass(), "SOUTH", (Program) semaine3);
        assertFieldIsDefined((Class) new int[0].getClass(), "EAST", (Program) semaine3);
        assertFieldIsDefined((Class) new int[0].getClass(), "WEST", (Program) semaine3);
    }
