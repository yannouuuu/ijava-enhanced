...
Ainsi, la première étape sera de stocker le theme, le sujet et la liste de mots dans des variables locales à la fonction `chargerCategorie` afin de pouvoir la terminer avec cette instruction : `return newCategorie(theme, sujet, mots);`.
