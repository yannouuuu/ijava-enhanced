...
**ATTENTION : comme nous n'avons pas encore vu cela en cours, il est bien sûr interdit d'utiliser le mot-clé `if`, `for`, `while` ou quoique soit d'autre non présenté ...
