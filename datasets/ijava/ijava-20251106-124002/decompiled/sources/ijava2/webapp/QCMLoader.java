...
public class QCMLoader {
    public static QCMDefinition loadFromResource(String str, String str2) {
        String str3 = "/syllabus/" + str + "/" + str2 + ".qcm";
        InputStream resourceAsStream = QCMLoader.class.getResourceAsStream(str3);
        if (resourceAsStream == null) {
            System.err.println("QCM definition not found: " + str3);
            return null;
        }
        try {
