...
L'exemple ci-dessus correspond aux premières lignes du fichier sur lequel porte les exercices suivants. Chargez le fichier `USPresident.csv` sur *Moodle* et affichez l'ensemble de son contenu grâce à la fonction `dump` du fichier `DumpCSV`.
