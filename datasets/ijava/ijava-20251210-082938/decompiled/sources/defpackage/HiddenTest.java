...
public class HiddenTest extends Program {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean functionIsDefined(String str, Program program) {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean functionIsDefined(String str, Class[] clsArr, Program program) {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void assertFieldIsDefined(Class cls, String str, Program program) {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void assertFieldIsDefined(Class cls, String str, Class<?> cls2) {
        try {
