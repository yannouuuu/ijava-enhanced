...
- [x] if (a == 5) { print(5); } else { print("zut");}
  > Parfait, bien joué !
- [ ] if (a = 5) { print(5); } else { print("zut");}
  > Aïe, aïe, aïe : NE PAS CONFONDRE l'opérateur d'AFFECTATION (=) pour modifier le contenu d'une variable et l'opérateur d'ÉGALITÉ (==) !!!
- [ ] if {a == 5} { print(5); } else { print("zut");}
...
- [ ] a - 2 * a / 2 == 0
  > Incorrect : même si cela fonctionnait, cela fait 4 opérations au lieu de deux ...
- [x] a % 2 == 0
  > Exactement : grâce l'opérateur du reste de la division entière (modulo).
- [ ] a / 2 == int
